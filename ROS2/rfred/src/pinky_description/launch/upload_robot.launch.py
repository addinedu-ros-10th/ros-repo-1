...
def generate_launch_description():
    ...
    - parameter - robot_description : urdf.xacro 확장자 파일 내용을 robot_state_publisher 노드의 파라미터로 로드
    """
    rsp_node = Node(
    ...
    - parameter - /robot : urdf.xacro 확장자 파일 내용을 robot_state_publisher 노드의 파라미터로 로드
    """
    jsp_node = Node(
